	<link rel="stylesheet" href="<?php echo base_url();?>styles/read_article.css" type="text/css" media="screen"/>
	
	<div id="content_area" class="grid_12">
		<div class="grid_9 read_article">
			
			<?php if(isset($selected_article) && $selected_article != NULL ) { ?>
				<?php
					foreach($selected_article as $row) {
				...
				<?php 
					$social_feature_url = current_url() . "?id=" . $article_id;
				?>
